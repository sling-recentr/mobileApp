...
import com.slingHealth.reCentr.activities.BluetoothLeService.Companion.RX_UUID
import com.slingHealth.reCentr.fragments.HomeFragment
import com.slingHealth.reCentr.fragments.StatsFragment
...
class DeviceConnectedActivity : AppCompatActivity() {
    ...
    private fun findUARTService(gattServices: List<BluetoothGattService>?) {
        ...
        for (gattService in gattServices) {
            ...
            if (name.equals("UART", ignoreCase = true)) {
                ...
                characteristic = uartService.getCharacteristic(RX_UUID)
    ...
    companion object {
        private val TAG = DeviceConnectedActivity::class.java.simpleName
